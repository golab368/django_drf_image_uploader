...
# class ImagesSerializerWithoutExpiration(serializers.ModelSerializer):
#     thumbnail_200 = serializers.SerializerMethodField()
#     thumbnail_400 = serializers.SerializerMethodField()
#     author = serializers.ReadOnlyField(source="author.username")
...
class ImagesSerializer(serializers.ModelSerializer):
    ...
    #         self.Meta.exclude += ('expiration_time',)
...
#         if thumbnail:
#             representation['thumbnail_200'] = thumbnail.thumbnail_200.url
#             representation['thumbnail_400'] = thumbnail.thumbnail_400.url
